...
const EditProfile = (props) => {
  ...
  const updateMe = () => {
    axios({
      method: 'PATCH',
      url: 'http://192.168.43.186:3000/api/v1/talent/profile/me',
      data: {
        user_id: props.auth.data.user_id,
        position: position,
        location: location,
      ...
      <ScrollView
        ...
        <View style={styles.thirdContainer}>
          <TouchableOpacity style={styles.buttonSave}>
            <Text onPress={updateMe}  style={styles.buttonSaveText}>Simpan</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.buttonCancel} onPress={() => props.navigation.navigate('Profile')}>
        ...
        <View style={styles.fourthContainer}>
          ...
          <View style={{ marginBottom: 32 }}>
            ...
            <TextInput onChangeText={(text) => setPosition(text)} style={styles.form} placeholder="Masukan job title" />
          </View>
          <View style={{ marginBottom: 32 }}>
            <Text style={styles.label}>Domisili</Text>
            <TextInput onChangeText={(text) => setLocation(text)} style={styles.form} placeholder="Masukan domisili" />
          </View>
          <View style={{ marginBottom: 32 }}>
