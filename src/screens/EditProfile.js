      ...
      <ScrollView style={styles.mainContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'center'}}>
            <Icon name='pencil' type='font-awesome' color='#9EA0A5' size={24} style={{marginTop: 5, marginRight: 5,}}/>
        ...
        <View style={styles.fourthContainer}>
          ...
          <View style={{marginBottom: 32}}>
            ...
            <TextInput style={styles.formDescription} multiline={true} placeholder="Masukan deskripsi singkat"/>
          </View>
        </View>
        ...
        <View style={styles.sixthContainer}>
          ...
          <TouchableOpacity style={styles.buttonSetting}>
            <Text style={styles.buttonSettingText}>Tambah pengalaman kerja</Text>
          </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.seventhContainer}>
          ...
          <View style={{marginBottom: 32}}>
            ...
            <TextInput style={styles.form} placeholder="Masukan nama aplikasi"/>
          </View>
          <View style={{marginBottom: 32}}>
            <Text style={styles.label}>Deskripsi singkat</Text>
            <TextInput style={styles.formDescription} multiline={true} placeholder="Masukan deskripsi singkat"/>
          ...
          <View style={{marginBottom: 32}}>
            ...
            <TextInput style={styles.form} placeholder="Masukan link publikasi"/>
          </View>
          <View style={{marginBottom: 32}}>
            <Text style={styles.label}>Link repository</Text>
            <TextInput style={styles.form} placeholder="Masukan link repository"/>
          </View>
          <View style={{marginBottom: 32}}>
            <Text style={styles.label}>Tempat kerja terkait</Text>
            <TextInput style={styles.form} placeholder="Masukan tempat kerja terkait"/>
          </View>
          <View style={{marginBottom: 32}}>
            ...
            <View style={{flexDirection: 'row'}}>
              <View style={{flexDirection: 'row'}}>
                <CheckBox value={isSelectedMobile} onValueChange={setSelectionMobile} />
                <Text style={styles.applicationType}>Aplikasi Mobile</Text>
              </View>
              <View style={{flexDirection: 'row', marginLeft: 20,}}>
                <CheckBox value={isSelectedWeb} onValueChange={setSelectionWeb} />
          ...
          <View style={{marginBottom: 32}}>
            <Text style={styles.label}>Upload gambar</Text>
              ...
              <Text style={{marginBottom: 20, marginTop: 25, textAlign: 'center', fontFamily: 'OpenSans-Regular', fontSize: 16, color: '#1F2A36'}}>Upload file penyimpanan</Text>
              <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                <View style={{flexDirection: 'row', marginRight: 20}}>
                  <Image source={photoRes}/>
                  <View style={{flexDirection: 'column'}}>
                    <Text style={{paddingLeft: 5, fontFamily: 'OpenSans-Regular', fontSize: 12, color: '#1F2A36'}}>High-Res Image</Text>
                    <Text style={{paddingLeft: 5, fontFamily: 'OpenSans-Regular', fontSize: 12, color: '#1F2A36'}}>PNG, JPG or GIF</Text>
                  </View>
                </View>
                <View style={{flexDirection: 'row'}}>
                  ...
                  <View style={{flexDirection: 'column'}}>
                    <Text style={{paddingLeft: 5, fontFamily: 'OpenSans-Regular', fontSize: 12, color: '#1F2A36'}}>High-Res Image</Text>
                    <Text style={{paddingLeft: 5, fontFamily: 'OpenSans-Regular', fontSize: 12, color: '#1F2A36'}}>1080x1920 / 600x800</Text>
                  </View>
                </View>
              </View>
